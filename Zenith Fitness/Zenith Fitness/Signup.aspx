...
<tr>
    <td colspan="2">
        ...
        <h2 style="color: green; margin-top: 20px; text-align: left;">
...
<tr>
    <td style="width: 260px">
        Age <asp:RequiredFieldValidator ID="rfvAge" runat="server" ErrorMessage="Age is required" ForeColor="Red" ControlToValidate="tbxAge" ValidationGroup="memberInfo">*</asp:RequiredFieldValidator>
    </td>
    <td style="width: 260px">
        Gender
...
<tr>
    ...
    <td style="height: 37px; width: 160px;"></td>
</tr>
<tr>
    <td style="height: 25px; width: 260px;">
        Cell Phone
    ...
    <td style="height: 25px; width: 260px;">Home Phone</td>
    <td style="height: 25px; width: 160px;">&nbsp;</td>
</tr>
<tr>
    <td style="width: 260px">
...
<tr>
    <td style="height: 25px; width: 260px;">
        <h2 style="color: green; text-align: left;">Create an Account</h2>
    </td>
    <td style="height: 25px; width: 260px;"></td>
    <td style="height: 25px; width: 160px;"></td>
</tr>
<tr>
    <td style="width: 260px">&nbsp;</td>
...
<tr>
    <td style="width: 260px">
        Username <asp:RequiredFieldValidator ID="rfvUsername" runat="server" ErrorMessage="Username is required" ForeColor="Red" ControlToValidate="tbxUsername" ValidationGroup="memberInfo">*</asp:RequiredFieldValidator>
    </td>
    <td style="width: 260px">
...
<tr>
    <td style="height: 23px; width: 260px;">
        Password <asp:RequiredFieldValidator ID="rfvPwd1" runat="server" ErrorMessage="Password is required" ForeColor="Red" ControlToValidate="tbxPwd1" ValidationGroup="memberInfo">*</asp:RequiredFieldValidator>
    </td>
    <td style="height: 23px; width: 260px;"></td>
    <td style="height: 23px; width: 160px;"></td>
</tr>
<tr>
    <td style="width: 260px">
...
<tr>
    <td style="width: 260px">
        Confirm Password <asp:RequiredFieldValidator ID="rfvPwd2" runat="server" ErrorMessage="Confirm password" ForeColor="Red" ControlToValidate="tbxPwd2" ValidationGroup="memberInfo">*</asp:RequiredFieldValidator>
    </td>
    <td style="width: 260px">&nbsp;</td>
    <td style="width: 160px">&nbsp;</td>
</tr>
...
<tr>
    <td style="height: 36px;" colspan="2">
        <h2 style="color: green; text-align: left;">Payment Option </h2>
    </td>
</tr>
<tr>
    <td style="width: 260px">
