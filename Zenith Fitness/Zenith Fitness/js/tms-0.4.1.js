            ...
            var th = $(this),
                ...
                _ = {
                        ...
                        fadeThree: function(el, last) {
                            ...
                            $(el).each(function(i) {
                                var th = $(this).show().css({ left: -_.width / 4, top: 0, zIndex: 2, opacity: 0 }),
                                    clone = th.clone().appendTo(th.parent())
                                        .css({ left: _.width / 4, top: _.height / 4, zIndex: 1 }),
                                    clone2 = th.clone().appendTo(th.parent())
                                        .css({ left: 0, top: -_.height / 4, zIndex: 1 });
                                ...
                                var src = _.next,
                                                ...
                                                ie
                                                    ? canvas.css({
                                                        ...
                                                        height: o.start.height +
                                                            (o.finish.height - o.start.height) * state
                                                    })
                                                    : ctx.drawImage(buff[0],
                                                        ...
                                                        im.width = o.start.width +
                                                        (o.finish.width - o.start.width) * state,
                                                        im.height = o.start.height +
                                                        (o.finish.height - o.start.height) * state);
                                            };
                                        refresh(0);
                                        clearInterval(_.int);
                                    ...
                                    calcCSS = function(width, height, k) {
                                        var motion = "zoom,move".split(",")[~~(Math.random() * 2)],
                                            side =
                                                "left,right,top,bottom,leftTop,leftBottom,center".split(",")[~~(
                                                    Math.random() * 7)],
                                        ...
                                        swtch(motion,
                                            {
                                                ...
                                                move: function() {
                                                    css = $.extend(true,
                                                        css,
                                                        side != "center"
                                                        ? { start: { width: width * k, height: height * k } }
                                                        : {});
                                ...
                                setTimeout(function() {
                                        _.pic
                                            .css({
                                                ...
                                                background: _.preset == "zoomer"
                                                    ? "none"
                                                    : ("url(" + _.itms[_.show] + ") 0 0 no-repeat")
                                            });
                                        img.remove();
                    ...
                    controlsFu: function() {
                        var _ = this;
                        if (_.nextBu)
                            $(_.nextBu).bind(_.changeEv,
                                function() {
                                    _.nextFu();
                                    return false;
                                });
                        if (_.prevBu)
                            $(_.prevBu).bind(_.changeEv,
                                function() {
                                    _.prevFu();
                                    return false;
                                });
                        ...
                        if (_.prog == 0)
                            ...
                            _.progressBar
                                ...
                                .animate({ width: _.prog / 100 * _.progressBar.parent().width() },
                                    { easing: "linear", duration: _.slideshow / 100 });
