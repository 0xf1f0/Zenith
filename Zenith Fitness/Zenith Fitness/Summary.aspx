...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    <div class="box-shadow" style="height: auto; left: 0px; margin-bottom: 400px; margin-top: 130px; top: 0px; width: auto;">
        <br/>
        <h2 style="color: green; text-align: center;">Order Summary</h2>
        <br/>
        <table id="summaryTable" style="margin-left: 20%; width: 60%;">
            <tr>
                <td style="height: 25px; width: 300px;" colspan="2">
                    <h3 style="background-color: #01A5CA; color: white">Membership Description</h3>
                </td>
                <td style="height: 25px">
                    <h3 style="background-color: #01A5CA; color: white"">Price</h3>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="height: 25px" colspan="2">
                    <h3>Total Recurring Monthly Fee:</h3>
                </td>
                <td style="height: 25px">
