...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    <br/>
    <div class="box-shadow" style="height: auto; left: 0px; margin-bottom: 400px; margin-top: 100px; top: 0px; width: auto;">
        ...
        <table id="account" style="margin-top: 10%;" class="auto-style3">
            ...
            <tr>
                <td colspan="4">
                    <h2 style="color: green; margin-top: 50px; text-align: left;">My Membership</h2>
            ...
            <tr>
                <td>
                    <p style="font: bold 15px Helvetica, sans-serif">PLAN</p>
                </td>
                <td>
                    <p style="font: bold 15px Helvetica, sans-serif">STATUS</p>
                </td>
                <td>
                    <p style="font-variant: normal; line-height: normal;" class="auto-style2">START DATE</p>
                </td>
                <td>
                    <p style="font: bold 15px Helvetica, sans-serif">EXPIRY DATE</p>
                </td>
            </tr>
            <tr>
